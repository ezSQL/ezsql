...
class ezSQL_mysqlTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConstructionWithParameters() {
        ...
        $this->object = new ezSQL_mysql(self::TEST_DB_USER, self::TEST_DB_PASSWORD, self::TEST_DB_HOST, self::TEST_DB_CHARSET);
        
        // Run all previous tests again
        $this->testQuick_connect();
        $this->testConnect();
        $this->testSelect();
        $this->testEscape();
        $this->testSysdate();
