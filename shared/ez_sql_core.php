...
require_once('ezQuery.php');
	...
	*/	
    ...
    private $all_func_calls = array();
		...
		*/
		public function get_var($query = null, $x = 0, $y = 0, $use_prepare = false)
		{
		...
		*/
		public function get_row($query = null, $output = OBJECT, $y = 0, $use_prepare = false)
		{
			// Log how the function was called
		...
		*/
		public function get_col($query = null, $x = 0, $use_prepare = false)
		{
			$new_array = array();
			// If there is a query then perform it if not then use cached results..
			if ( $query ) {
		...
		/**  
		* Return the the query as a result set, will use prepare statements 
		* if setup - see docs for more details
		*/
		public function get_results($query = null, $output = OBJECT, $use_prepare = false) 
		{
			// Log how the function was called
